...
import ShadowsOfCaptainPastProdScr from './appSource/captainScreens/ShadowsOfCaptainPastProdScr';
...
const App = () => {
      ...
      OneSignal.initialize('c22d7fff-de4d-4eba-b281-710e648580fc');
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-05-19T13:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="ShadowsOfCaptainPastProdScr"
                                    component={ShadowsOfCaptainPastProdScr}
            ...
            <NavigationContainer>
                  {!louderIsEnded || !aceptTransperency || !completeLink ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./appSource/capLouder/l1.png')}
                                    style={{
                                          //...props.style,
                              ...
                              />
                              <Animated.Image
                                    source={require('./appSource/capLouder/l2.jpg')}
                                    style={{
                                          //...props.style,
